...
const Work = () => (
  <Layout title="Personal Web">
    <Container>
      ...
      <P>
        This is a simple website i used to use as a my personal website for showcasing my services.
      </P>
      <P>
        <Link href="https://youtu.be/0YFrGy_mzjY?si=y-xKe4rKd6zP_2ve" target="_blank">
          Greatstack <ExternalLinkIcon mx="2px" />
        </Link>
        , helped inspire to make this site and it was my first project in web devlopment.
        ...
        <ListItem>
          ...
          <span>
            <Link href="https://kmralb.github.io/experimental/" target="_blank">
              https://kmralb.github.io/experimental/ <ExternalLinkIcon mx="2px" />
            </Link>
          </span>
        </ListItem>
                <ListItem>
